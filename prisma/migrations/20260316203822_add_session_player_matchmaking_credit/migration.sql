...
INSERT INTO "new_SessionPlayer" ("availableSince", "gender", "id", "inactiveSeconds", "isGuest", "isPaused", "joinedAt", "lastPartnerId", "lastPlayedAt", "matchesPlayed", "partnerPreference", "pausedAt", "sessionId", "sessionPoints", "userId") SELECT "availableSince", "gender", "id", "inactiveSeconds", "isGuest", "isPaused", "joinedAt", "lastPartnerId", "lastPlayedAt", "matchesPlayed", "partnerPreference", "pausedAt", "sessionId", "sessionPoints", "userId" FROM "SessionPlayer";
