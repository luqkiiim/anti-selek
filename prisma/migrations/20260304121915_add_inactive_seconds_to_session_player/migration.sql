...
INSERT INTO "new_SessionPlayer" ("availableSince", "id", "isPaused", "joinedAt", "lastPartnerId", "lastPlayedAt", "matchesPlayed", "pausedAt", "sessionId", "sessionPoints", "userId") SELECT "availableSince", "id", "isPaused", "joinedAt", "lastPartnerId", "lastPlayedAt", "matchesPlayed", "pausedAt", "sessionId", "sessionPoints", "userId" FROM "SessionPlayer";
