...
export function StatCard({
  ...
  return (
    <div className={cx("app-stat-card p-5", accent && "bg-[linear-gradient(180deg,rgba(219,233,221,0.95),rgba(255,255,255,0.88))]")}>
...
export function HeroCard({
  ...
  return (
    <section className="app-panel relative overflow-hidden px-5 py-6 sm:px-6">
      <div className="pointer-events-none absolute inset-y-0 right-[-5rem] top-[-2rem] w-56 rounded-full bg-[radial-gradient(circle,_rgba(77,139,91,0.12),_transparent_65%)] blur-2xl" />
