...
function buildPlayer(overrides: Partial<ClubPageMember> = {}): ClubPageMember {
  return {
    id: "placeholder-1",
    name: "Old Member",
    email: null,
...
function buildClaimState(overrides: Partial<ClubLeaderboardClaimState> = {}): ClubLeaderboardClaimState {
  return {
    currentUser: {
      id: "requester-1",
      name: "New Signup",
