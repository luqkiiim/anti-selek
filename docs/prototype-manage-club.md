...
Player editing also exposes the existing gender-specific mixed-pair level and Competitive/Social preferred game group. Level saves keep the legacy partner preference consistent, including when resetting to Default. Mobile save/reopen/reset checks passed for male and female players.
